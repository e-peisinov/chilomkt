<div>
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Pagina de Inicio</h1>
            <p class="text-gray-500 text-sm mt-1">Gestiona el contenido de la pagina principal</p>
        </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden" x-data="{ open: false }">
            <button @click="open = !open" class="w-full flex items-center justify-between p-4 hover:bg-gray-50 transition-colors">
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-xs text-gray-400">Titulo, subtitulo y botones</span>
                </div>
                ...
                <div class="p-4">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-400 mt-1">Imagen principal del hero (recomendado: 600x400px)</p>
                        </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden" x-data="{ open: false }">
            <button @click="open = !open" class="w-full flex items-center justify-between p-4 hover:bg-gray-50 transition-colors">
                <div class="flex items-center gap-3">
                    ...
                    <span class="font-semibold text-gray-900">Estadisticas del Hero</span>
                    <span class="text-xs text-gray-400">Numeros destacados</span>
                </div>
                <svg class="w-5 h-5 text-gray-400 transition-transform duration-300" :class="open && 'rotate-180'" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
            </button>
            <div x-show="open" x-collapse class="border-t border-gray-100">
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden" x-data="{ open: false }">
            <button @click="open = !open" class="w-full flex items-center justify-between p-4 hover:bg-gray-50 transition-colors">
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-xs text-gray-400">Titulo de seccion + cards de servicios</span>
                </div>
                <svg class="w-5 h-5 text-gray-400 transition-transform duration-300" :class="open && 'rotate-180'" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
            </button>
            <div x-show="open" x-collapse class="border-t border-gray-100">
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden" x-data="{ open: false }">
            <button @click="open = !open" class="w-full flex items-center justify-between p-4 hover:bg-gray-50 transition-colors">
                <div class="flex items-center gap-3">
                    ...
                    <span class="font-semibold text-gray-900">Como Trabajamos</span>
                ...
                <div class="p-4">
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Subtitulo (badge)</label>
                                ...
                                @foreach($pasos as $i => $paso)
                                    <div class="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                                        ...
                                        <div class="flex-1 space-y-2">
                                            <input wire:model="pasos.{{ $i }}.titulo" type="text" placeholder="Titulo del paso" class="w-full rounded-lg border-gray-300 text-sm focus:border-chilo-dark focus:ring-chilo-dark">
                                            <input wire:model="pasos.{{ $i }}.descripcion" type="text" placeholder="Descripcion" class="w-full rounded-lg border-gray-300 text-sm focus:border-chilo-dark focus:ring-chilo-dark">
                                        </div>
                        ...
                        <div class="border-t border-gray-100 pt-4">
                            ...
                            <p class="text-xs text-gray-400 mt-1">Imagen que acompana los pasos del proceso (recomendado: 600x500px)</p>
                        </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden" x-data="{ open: false }">
            <button @click="open = !open" class="w-full flex items-center justify-between p-4 hover:bg-gray-50 transition-colors">
                <div class="flex items-center gap-3">
                    ...
                    <span class="font-semibold text-gray-900">Testimonios</span>
                    <span class="text-xs text-gray-400">Opiniones de clientes</span>
                </div>
                <svg class="w-5 h-5 text-gray-400 transition-transform duration-300" :class="open && 'rotate-180'" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
            </button>
            <div x-show="open" x-collapse class="border-t border-gray-100">
                <div class="p-4">
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Titulo de la seccion</label>
                                <input wire:model="secciones.inicio_testimonios.titulo" type="text" class="w-full rounded-lg border-gray-300 text-sm focus:border-chilo-dark focus:ring-chilo-dark">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Subtitulo</label>
                                <input wire:model="secciones.inicio_testimonios.subtitulo" type="text" class="w-full rounded-lg border-gray-300 text-sm focus:border-chilo-dark focus:ring-chilo-dark">
                            </div>
                        </div>
                        <button wire:click="guardarSeccion('inicio_testimonios')" class="bg-chilo-dark text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-chilo transition-colors">
                            Guardar titulo
                        </button>

                        <div class="border-t border-gray-100 pt-4">
                            <div class="flex items-center justify-between mb-3">
                                <h4 class="font-medium text-gray-900 text-sm">Testimonios ({{ $testimonios->count() }})</h4>
                                <button wire:click="crearTestimonio" class="bg-chilo-dark text-white px-3 py-1.5 rounded-lg text-xs font-medium hover:bg-chilo transition-colors flex items-center gap-1">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
                                    Agregar
                                </button>
                            </div>
                            <div class="space-y-2">
                                @foreach($testimonios as $testimonio)
                                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                        <div class="flex items-center gap-3">
                                            @if($testimonio->foto)
                                                <img src="{{ asset('storage/' . $testimonio->foto) }}" class="w-8 h-8 rounded-full object-cover" alt="">
                                            @else
                                                <span class="w-8 h-8 bg-chilo-dark/10 rounded-full flex items-center justify-center text-xs font-bold text-chilo-dark">{{ mb_substr($testimonio->nombre, 0, 1) }}</span>
                                            @endif
                                            <div>
                                                <span class="text-sm font-medium text-gray-900">{{ $testimonio->nombre }}</span>
                                                <span class="text-xs text-gray-400 ml-2">{{ $testimonio->cargo }}{{ $testimonio->empresa ? ' - ' . $testimonio->empresa : '' }}</span>
                                            </div>
                                        ...
                                        <div class="flex items-center gap-1">
                                            <button wire:click="editarTestimonio({{ $testimonio->id }})" class="text-gray-400 hover:text-chilo-dark p-1">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                            </button>
                                            <button wire:click="eliminarTestimonio({{ $testimonio->id }})" wire:confirm="Eliminar este testimonio?" class="text-gray-400 hover:text-red-600 p-1">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>
                                            </button>
                                        </div>
                                    </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden" x-data="{ open: false }">
            <button @click="open = !open" class="w-full flex items-center justify-between p-4 hover:bg-gray-50 transition-colors">
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-xs text-gray-400">Seccion final con boton</span>
                </div>
                <svg class="w-5 h-5 text-gray-400 transition-transform duration-300" :class="open && 'rotate-180'" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
            </button>
            <div x-show="open" x-collapse class="border-t border-gray-100">
    ...
    {{-- MODAL TESTIMONIO --}}
    @if($mostrarModalTestimonio)
        <div class="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" wire:click.self="$set('mostrarModalTestimonio', false)">
            <div class="bg-white rounded-xl w-full max-w-lg p-6">
                <h3 class="text-lg font-bold text-gray-900 mb-4">{{ $testimonioId ? 'Editar' : 'Nuevo' }} Testimonio</h3>
                <div class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Nombre *</label>
                            <input wire:model="testimonioNombre" type="text" class="w-full rounded-lg border-gray-300 text-sm">
                            @error('testimonioNombre') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Cargo</label>
                            <input wire:model="testimonioCargo" type="text" class="w-full rounded-lg border-gray-300 text-sm">
                        </div>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Empresa</label>
                        <input wire:model="testimonioEmpresa" type="text" class="w-full rounded-lg border-gray-300 text-sm">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Contenido *</label>
                        <textarea wire:model="testimonioContenido" rows="3" class="w-full rounded-lg border-gray-300 text-sm"></textarea>
                        @error('testimonioContenido') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Foto</label>
                            <input wire:model="testimonioFoto" type="file" accept="image/*" class="w-full text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Orden</label>
                            <input wire:model="testimonioOrden" type="number" min="0" class="w-full rounded-lg border-gray-300 text-sm">
                        </div>
                    </div>
                    <div class="flex items-center gap-2">
                        <input wire:model="testimonioActivo" type="checkbox" id="testActivo" class="rounded border-gray-300 text-chilo-dark focus:ring-chilo-dark">
                        <label for="testActivo" class="text-sm text-gray-700">Activo</label>
                    </div>
                    <div class="flex justify-end gap-3 pt-2">
                        <button wire:click="$set('mostrarModalTestimonio', false)" class="px-4 py-2 text-sm text-gray-600 hover:text-gray-900">Cancelar</button>
                        <button wire:click="guardarTestimonio" class="bg-chilo-dark text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-chilo transition-colors">Guardar</button>
                    </div>
                </div>
            </div>
        </div>
